...
// import db from "@/lib/db";
// import Seller from "@/models/seller"; // NOTE: Ensure filename casing matches (Seller vs seller)
// import User from "@/models/user"; 
// import bcrypt from "bcryptjs";
// import sendVerificationEmail from "@/lib/mailer"; 
...
//       shopType,
//       shopAddress,
//       shopLocation, // Frontend likely sends { lat: ..., lng: ... }
//       shopBanner,
//       verificationDocs,
//     } = body;
...
//     // --- 4. FIX: Format GeoJSON Location ---
//     // MongoDB requires [Longitude, Latitude]
//     // Default to [0,0] if not provided to prevent crash
//     let formattedLocation = {
//       type: "Point",
//       coordinates: [0, 0] 
//     };
...
//       shopType,
//       shopAddress,
//       shopLocation: formattedLocation, // <--- USE THE FORMATTED OBJECT
//       shopBanner,
//       verificationDocs,
//       verificationToken: otp, 
//       verificationExpires: tokenExpiry,
