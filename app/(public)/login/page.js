...
//   useEffect(() => {
//     if (status === "authenticated") {
//       // ✅ FIX: Corrected typo from "sellor" to "seller"
//       if (session.user.role === "seller") {
//         router.push("/vendor/dashboard");
//       } else {
//         router.push("/");
...
//     try {
//       // ✅ This is the correct, secure NextAuth signIn function
//       const res = await signIn("credentials", {
//         redirect: false,
//         identifier: form.identifier,
//         password: form.password,
...
//         throw new Error(res.error);
//       }
//       // Successful sign-in will now be handled by the useEffect
//       toast.success("Login Successful!", {
//         description: "Redirecting to your dashboard..."
//       });
...
//       <div className="flex justify-center items-center h-full my-14 p-4 bg-gray-50 dark:bg-gray-900">
//         <VerificationMessage />
...
//                         variant="link"
//                         disabled={isResending}
//                         className="p-0 h-auto text-xs text-red-300 underline"
//                       >
//                         {isResending ? <Loader2 className="w-4 h-4 animate-spin"/> : "Resend Email"}
//                       </Button>
//                     )}
...
//           </CardContent>
//           <CardFooter className="flex flex-col items-center gap-2 text-sm">
//              {/* ✅ Restored Next.js Link for better performance */}
