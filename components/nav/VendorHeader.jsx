...
//   return (
//     <header className="flex items-center justify-between h-16 px-4 md:px-6 bg-white border-b sticky top-0 z-40">
...
//           <span className="text-lg font-bold text-gray-800">ShopSync</span>
//         </div>
//       </div>
    ...
    <header className="flex items-center justify-between h-16 px-4 md:px-6 bg-background border-b border-border sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-foreground">ShopSync</span>
        </div>
      </div>
